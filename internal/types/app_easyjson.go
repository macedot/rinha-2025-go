...
func easyjsonD2c14bDecodeGithubComMacedotRinha2025GoInternalTypes2(in *jlexer.Lexer, out *PaymentRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD2c14bEncodeGithubComMacedotRinha2025GoInternalTypes2(out *jwriter.Writer, in PaymentRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
